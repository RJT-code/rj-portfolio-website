  ...
  return <section id="skills" className="bg-surface py-20 sm:py-24 lg:py-28" aria-labelledby="skills-title">
    <Container>
      <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
        <SectionHeading eyebrow="Skills & technologies" headingId="skills-title" title="A focused toolkit for modern web work." description="A practical mix of frontend technologies, design practices, and delivery tools used to create dependable digital experiences." />
      </div>
