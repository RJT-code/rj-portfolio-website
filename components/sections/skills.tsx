  ...
  return <section id="skills" className="bg-surface py-20 sm:py-24 lg:py-28" aria-labelledby="skills-title">
    <Container>
      ...
      <div className="mt-12 grid gap-5 lg:grid-cols-3">
        {skillGroups.map((group, index) => <Reveal key={group.title} className="h-full" delay={index * 70}><article className="h-full rounded-2xl border border-border bg-surface p-6 sm:p-8">
