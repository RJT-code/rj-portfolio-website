  ...
  return <section id="services" className="border-y border-border/80 bg-blue-mist py-20 sm:py-24 lg:py-28" aria-labelledby="services-title">
    <Container>
      ...
      <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        {services.map((service, index) => <Reveal key={service.title} className="h-full" delay={index * 70}><article className="group flex h-full flex-col md:min-h-80 rounded-2xl border border-border bg-surface p-6 shadow-soft transition duration-200 motion-reduce:transition-none sm:p-8 md:hover:-translate-y-1 md:hover:border-border-strong">
